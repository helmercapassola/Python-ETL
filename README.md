...
- [Listas e Tamanho de Listas](#listas-e-tamanho-de-listas)
- [Ambiente Virtual](#ambiente-virtual-para-isolar-dependências)
- [Manipulação de Arquivos Excel e CSV](#manipulação-de-arquivos-excel-e-csv)
